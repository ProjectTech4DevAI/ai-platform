...
def upgrade():
    ...
    op.add_column('apikey', sa.Column('key_prefix', sqlmodel.sql.sqltypes.AutoString(), nullable=False))
    op.add_column('apikey', sa.Column('key_hash', sqlmodel.sql.sqltypes.AutoString(), nullable=False))
