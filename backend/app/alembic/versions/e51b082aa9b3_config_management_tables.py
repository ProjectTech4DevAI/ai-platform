...
def upgrade():
    ...
    op.create_index(
        op.f("ix_config_project_id"), "config", ["project_id"], unique=False
    )
    op.create_table(
        "config_version",
        sa.Column(
    ...
    op.create_index(
        op.f("ix_config_version_config_id"),
        "config_version",
        ["config_id"],
        unique=False,
    )
    op.drop_constraint(
        op.f("openai_conversation_project_id_fkey1"),
        "openai_conversation",
        type_="foreignkey",
    )
    op.drop_constraint(
        op.f("openai_conversation_organization_id_fkey1"),
        "openai_conversation",
        type_="foreignkey",
    )
