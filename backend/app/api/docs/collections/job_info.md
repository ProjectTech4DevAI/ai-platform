...
* Fetching the collection job object containing the ID which will be collection job id, status of the job as well as collection object.
...
* If the job of delete collection was successful, we will get the status as successful and collection key will just contain the collection id being or hs been deleted.
