...
def execute_high_priority_task(self, function_path: str, user_id: int, job_id: str, **kwargs):
    ...
    """
    return _execute_job_internal(self, function_path, user_id, job_id, "high_priority", **kwargs)
...
def execute_low_priority_task(self, function_path: str, user_id: int, job_id: str, **kwargs):
    ...
    Args:
        ...
        **kwargs: Additional arguments to pass to the execute_job function
    """
    return _execute_job_internal(self, function_path, user_id, job_id, "low_priority", **kwargs)
