...
class CasbinRule(SQLModel, table=True):
    ...
    ptype: str = Field(index=True, max_length=255) # "p" for policy rule, "g" for grouping (role) rule
    ...
    v3: Optional[str] = Field(default=None, max_length=255)  # Object (in policy) or unused
    v4: Optional[str] = Field(default=None, max_length=255)  # Action (in policy) or unused
    v5: Optional[str] = Field(default=None, max_length=255)  # Effect ("allow"/"deny") or unused
