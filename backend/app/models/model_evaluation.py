...
class ModelEvaluation(ModelEvaluationBase, table=True):
    ...
    test_data_url: str = Field(description="S3 url of the testing data stored ins S3")
    ...
    testing_file_id: Optional[str] = Field(
        description="File ID of the testing file uploaded to OpenAI for Batch processing"
    )
    ...
    batch_id: Optional[str] = Field(
        description="ID of the batch job created for processing test data queries"
    )
    output_file_id: Optional[str] = Field(
        description="ID of the output file generated by OpenAI Batch processing"
    )
    batch_status: Optional[str] = Field(
        description="Current status of the batch job on OpenAI's side"
    )
    prediction_data_url: str | None = Field(
        default=None,
...
class ModelEvaluationUpdate(SQLModel):
    ...
    prediction_data_url: Optional[str] = None
