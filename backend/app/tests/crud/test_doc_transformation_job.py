...
class TestDocTransformationJobCrudCreate:
    def test_can_create_job_with_valid_document(self, db: Session, store: DocumentStore, crud: DocTransformationJobCrud):
    ...
    def test_cannot_create_job_with_invalid_document(self, db: Session, store: DocumentStore, crud: DocTransformationJobCrud):
    ...
    def test_cannot_create_job_with_deleted_document(self, db: Session, store: DocumentStore, crud: DocTransformationJobCrud):
...
class TestDocTransformationJobCrudReadOne:
    def test_can_read_existing_job(self, db: Session, store: DocumentStore, crud: DocTransformationJobCrud):
    ...
    def test_cannot_read_nonexistent_job(self, db: Session, store: DocumentStore, crud: DocTransformationJobCrud):
    ...
    def test_cannot_read_job_with_deleted_document(self, db: Session, store: DocumentStore, crud: DocTransformationJobCrud):
    ...
    def test_cannot_read_job_from_different_project(self, db: Session, store: DocumentStore):
...
class TestDocTransformationJobCrudReadEach:
    def test_can_read_multiple_existing_jobs(self, db: Session, store: DocumentStore, crud: DocTransformationJobCrud):
    ...
    def test_read_partial_existing_jobs(self, db: Session, store: DocumentStore, crud: DocTransformationJobCrud):
    ...
    def test_read_empty_job_set(self, db: Session, store: DocumentStore, crud: DocTransformationJobCrud):
        """Test reading an empty set of job IDs."""
        results = crud.read_each(set())
        
        assert len(results) == 0

    def test_cannot_read_jobs_from_different_project(self, db: Session, store: DocumentStore):
...
class TestDocTransformationJobCrudUpdateStatus:
    def test_can_update_status_to_processing(self, db: Session, store: DocumentStore, crud: DocTransformationJobCrud):
    ...
    def test_can_update_status_to_completed_with_result(self, db: Session, store: DocumentStore, crud: DocTransformationJobCrud):
    ...
    def test_can_update_status_to_failed_with_error(self, db: Session, store: DocumentStore, crud: DocTransformationJobCrud):
    ...
    def test_cannot_update_nonexistent_job(self, db: Session, store: DocumentStore, crud: DocTransformationJobCrud):
    ...
    def test_update_preserves_existing_fields(self, db: Session, store: DocumentStore, crud: DocTransformationJobCrud):
        """Test that updating status preserves other fields when not specified."""
        document = store.put()
        job = crud.create(document.id)
        
        # First update with error message
        crud.update_status(job.id, TransformationStatus.FAILED, error_message="Initial error")
